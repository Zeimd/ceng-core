...
namespace Ceng
{
	...
	public:
		...
		CRESULT ClearTarget_new(const CE_Color& color, const Ceng::Rectangle* scissorRect);
	...
	protected:
		...
		CRESULT ClearTargetComplex(const CE_Color& color, const Ceng::Rectangle& localRect);
