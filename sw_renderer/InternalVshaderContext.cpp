...
InternalVshaderContext::~InternalVshaderContext()
{
}
...
CRESULT InternalVshaderContext::ProcessVertexBatch(std::shared_ptr<DrawBatch> batch,
...
void InternalVshaderContext::ShaderFunction()
{
