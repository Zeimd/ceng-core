...
namespace Ceng::Pshader
{
	...
	*/
	...
	template<class T>
	class alignas(16) BasicSOAVec32
	{
	public:
		union
		{
		...
		inline BasicSOAVec32()
		{

		}

		inline BasicSOAVec32(T a, T b, T c, T d)
			: a(a), b(b), c(c), d(d)
		{

		}

		inline BasicSOAVec32(T a)
			: a(a), b(a), c(a), d(a)
		{
	...
	template<class T>
	inline BasicSOAVec32<T> operator == (const BasicSOAVec32<T>& x, const BasicSOAVec32<T>& y)
	{
	...
	class alignas(16) SOAVecBool : public BasicSOAVec32<Ceng::BOOL>
	{
	public:
		...
		inline SOAVecBool(const SOAVecBool& source)
			: BasicSOAVec32(source.a, source.b, source.c, source.d)
		{
	...
	template<class T>
	class alignas(16) NumericSOAVec32 : public BasicSOAVec32<T>
	{
	public:

		using BasicSOAVec32<T>::arr;
		using BasicSOAVec32<T>::a;
		using BasicSOAVec32<T>::b;
		using BasicSOAVec32<T>::c;
		using BasicSOAVec32<T>::d;

		inline NumericSOAVec32()
		{

		}

		inline NumericSOAVec32(T a, T b, T c, T d)
			: BasicSOAVec32<T>(a,b,c,d)
		{

		}

		inline NumericSOAVec32(T x)
			: BasicSOAVec32<T>(x)
		{

		}

		inline NumericSOAVec32& operator += (const NumericSOAVec32& other)
		{
			a += other.a;
			b += other.b;
			c += other.c;
	...
	template<class T>
	inline NumericSOAVec32<T> operator + (const NumericSOAVec32<T>& x, const NumericSOAVec32<T>& y)
	{
		return { x.a + y.a, x.b + y.b, x.c + y.c, x.d + y.d };
	}
	...
	template<class T>
	inline NumericSOAVec32<T> operator * (const NumericSOAVec32<T>& x, const Ceng::FLOAT32 y)
	{
		return { x.a * y, x.b * y, x.c * y, x.d * y };
	}
	...
	template<class T>
	inline SOAVecBool operator == (const NumericSOAVec32<T>& x, const NumericSOAVec32<T>& y)
	{
		return { x.a == y.a, x.b == y.b, x.c == y.c, x.d == y.d };
	}
	...
	template<class T>
	class alignas(16) IntegerSOAVec32 : public NumericSOAVec32<T>
	{
	public:

		using NumericSOAVec32<T>::arr;
		using NumericSOAVec32<T>::a;
		using NumericSOAVec32<T>::b;
		using NumericSOAVec32<T>::c;
		using NumericSOAVec32<T>::d;

		inline IntegerSOAVec32()
		{

		}

		inline IntegerSOAVec32(T a, T b, T c, T d)
			: NumericSOAVec32<T>(a, b, c, d)
		{

		}

		inline IntegerSOAVec32(T a)
			: NumericSOAVec32<T>(a)
		{

		}

		inline IntegerSOAVec32& operator <<= (const IntegerSOAVec32& other)
		{
			a <<= other.a;
			b <<= other.b;
			c <<= other.c;
	...
	template<class T>
	inline IntegerSOAVec32<T> operator + (const IntegerSOAVec32<T>& x, const IntegerSOAVec32<T>& y)
	{
		return { x.a + y.a, x.b + y.b, x.c + y.c, x.d + y.d };
	}
	...
	template<class T>
	inline SOAVecBool operator == (const IntegerSOAVec32<T>& x, const IntegerSOAVec32<T>& y)
	{
		return { x.a == y.a, x.b == y.b, x.c == y.c, x.d == y.d };
	}
	...
	using SOAVecFloat = NumericSOAVec32<Ceng::FLOAT32>;

	template<class T, class GroupType, class Datatype>
	class BaseSwizzled1
	{
	public:
		GroupType* base;
	...
	public:
		...
		inline BaseSwizzled1(GroupType* base, Ceng::UINT32 a)
			: base(base), a(a)
		{

		}

		inline BaseSwizzled1& operator = (T x)
		{
			base[a] = x;
			return *this;
		}

		inline BaseSwizzled1& operator = (const Datatype& source)
		{
			base[a] = source.x;
			return *this;
		}

		inline BaseSwizzled1& operator = (const BaseSwizzled1& source)
		{
	...
	public:
		...
		inline BaseSwizzled2(GroupType* base, Ceng::UINT32 a, Ceng::UINT32 b)
			: base(base), a(a), b(b)
		{

		}

		inline BaseSwizzled2& operator = (const Datatype& source)
		{
			if (base == &source._x)
			{
				GroupType temp[2];
		...
		inline BaseSwizzled2& operator = (const BaseSwizzled2& source)
		{
			if (base == source.base)
			{
				GroupType temp[2];
	...
	public:
		...
		inline BaseSwizzled3(GroupType* base, Ceng::UINT32 a, Ceng::UINT32 b, Ceng::UINT32 c)
			: base(base), a(a), b(b), c(c)
		{

		}

		inline BaseSwizzled3& operator = (const Datatype& source)
		{
			if (base == &source._x)
			{
				GroupType temp[3];
		...
		inline BaseSwizzled3& operator = (const BaseSwizzled3& source)
		{
			if (base == source.base)
			{
				GroupType temp[3];
	...
	public:
		...
		inline BaseSwizzled4(GroupType* base, Ceng::UINT32 a, Ceng::UINT32 b, Ceng::UINT32 c, Ceng::UINT32 d)
			: base(base), a(a), b(b), c(c), d(d)
		{

		}

		inline BaseSwizzled4& operator = (const Datatype& source)
		{
			if (base == &source._x)
			{
				GroupType temp[4];
		...
		inline BaseSwizzled4& operator = (const BaseSwizzled4& source)
		{
			if (base == source.base)
			{
				GroupType temp[4];
	...
	public:
		...
		inline ConstBaseSwizzled1(GroupType* base, Ceng::UINT32 a)
			: base(base), a(a)
		{
	...
	public:
		...
		inline ConstBaseSwizzled2(GroupType* base, Ceng::UINT32 a, Ceng::UINT32 b)
			: base(base), a(a), b(b)
		{
	...
	public:
		...
		inline ConstBaseSwizzled3(GroupType* base, Ceng::UINT32 a, Ceng::UINT32 b, Ceng::UINT32 c)
			: base(base), a(a), b(b), c(c)
		{
	...
	public:
		...
		inline ConstBaseSwizzled4(GroupType* base, Ceng::UINT32 a, Ceng::UINT32 b, Ceng::UINT32 c, Ceng::UINT32 d)
			: base(base), a(a), b(b), c(c), d(d)
		{
	...
	class NumericSwizzled1 : public BaseSwizzled1<T, NumericSOAVec32<T>, Datatype>
	{
	public:		

		using BaseSwizzled1<T, NumericSOAVec32<T>, Datatype>::base;
		using BaseSwizzled1<T, NumericSOAVec32<T>, Datatype>::a;

	public:

		inline NumericSwizzled1& operator += (const Datatype& source)
		{
			base[a] += source.x;
			return *this;
		}

		inline NumericSwizzled1& operator += (const NumericSwizzled1& source)
		{
			base[a] += source.base[source.a];
			return *this;
		}
	...
	template<class T, class Datatype>
	class NumericSwizzled2 : public BaseSwizzled2<T, NumericSOAVec32<T>, Datatype>
	{
	public:

		using BaseSwizzled2<T, NumericSOAVec32<T>, Datatype>::base;
		using BaseSwizzled2<T, NumericSOAVec32<T>, Datatype>::a;
		using BaseSwizzled2<T, NumericSOAVec32<T>, Datatype>::b;

	public:

		inline NumericSwizzled2& operator += (const Datatype& source)
		{
			if (base == &source._x)
			{
				NumericSOAVec32<T> temp[2];
		...
		inline NumericSwizzled2& operator += (const NumericSwizzled2& source)
		{
			if (base == source.base)
			{
				NumericSOAVec32<T> temp[2];
	...
	template<class T, class Datatype>
	class NumericSwizzled3 : public BaseSwizzled3<T, NumericSOAVec32<T>, Datatype>
	{
	public:

		using BaseSwizzled3<T, NumericSOAVec32<T>, Datatype>::base;
		using BaseSwizzled3<T, NumericSOAVec32<T>, Datatype>::a;
		using BaseSwizzled3<T, NumericSOAVec32<T>, Datatype>::b;
		using BaseSwizzled3<T, NumericSOAVec32<T>, Datatype>::c;

	public:

		inline NumericSwizzled3& operator += (const Datatype& source)
		{
			if (base == &source._x)
			{
				NumericSOAVec32<T> temp[3];
		...
		inline NumericSwizzled3& operator += (const NumericSwizzled3& source)
		{
			if (base == source.base)
			{
				NumericSOAVec32<T> temp[3];
	...
	template<class T, class Datatype>
	class NumericSwizzled4 : public BaseSwizzled4<T, NumericSOAVec32<T>, Datatype>
	{
	public:

		using BaseSwizzled4<T, NumericSOAVec32<T>, Datatype>::base;
		using BaseSwizzled4<T, NumericSOAVec32<T>, Datatype>::a;
		using BaseSwizzled4<T, NumericSOAVec32<T>, Datatype>::b;
		using BaseSwizzled3<T, NumericSOAVec32<T>, Datatype>::c;
		using BaseSwizzled3<T, NumericSOAVec32<T>, Datatype>::d;

	public:

		inline NumericSwizzled4& operator += (const Datatype& source)
		{
			if (base == &source._x)
			{
				NumericSOAVec32<T> temp[4];
		...
		inline NumericSwizzled4& operator += (const NumericSwizzled4& source)
		{
			if (base == source.base)
			{
				NumericSOAVec32<T> temp[4];
	...
	template<class T, class GroupType>
	class alignas(16) SOABase1;

	template<class T, class GroupType, class Datatype, class SwizzledType, class ConstSwizzledType>
	class alignas(16) SOABase3;

	template<class T, class GroupType, class Datatype, class SwizzledType, class ConstSwizzledType>
	class alignas(16) SOABase4;

	template<class T, class GroupType, class Datatype, class SwizzledType, class ConstSwizzledType>
	class alignas(16) SOABase2
	{
	public:
		GroupType _x;
		GroupType _y;
	...
	public:
		...
		inline SOABase2(const GroupType& a, const GroupType& b)
			: _x(a), _y(b)
		{

		}

		inline SOABase2(T a, T b)
			: _x(a), _y(b)
		{

		}

		inline SOABase2& operator= (const SOABase1<T, GroupType>& other)
		{
			_x = other.x;
			_y = 0.0f;
		...
		inline SOABase2& operator= (const SOABase2& other)
		{
			_x = other._x;
			_y = other._y;
		...
		SOABase2& operator= (const SOABase3<T, GroupType, Datatype, SwizzledType, ConstSwizzledType>& other);

		SOABase2& operator= (const SOABase4<T, GroupType, Datatype, SwizzledType, ConstSwizzledType>& other);

		SOABase2& operator= (const SwizzledType& other);

		SOABase2& operator= (const ConstSwizzledType& other);

		SwizzledType x();
		SwizzledType y();

		ConstSwizzledType xx();
		SwizzledType xy();
		SwizzledType yx();
		ConstSwizzledType yy();
	};

	template<class T, class GroupType>
	class alignas(16) SOANumeric2 : public SOABase2<T, NumericSOAVec32<T>, SOANumeric2<T,GroupType>, NumericSwizzled1<T, SOANumeric2<T, GroupType>>, ConstBaseSwizzled1<T, NumericSOAVec32<T>, SOANumeric2<T, GroupType>>>
	{
	public:
		
		using BaseType = SOABase2<T, NumericSOAVec32<T>, SOANumeric2<T, GroupType>, NumericSwizzled1<T, SOANumeric2<T, GroupType>>, ConstBaseSwizzled1<T, NumericSOAVec32<T>, SOANumeric2<T, GroupType>>>;

		using BaseType::_x;
		using BaseType::_y;

		using SwizzledType = NumericSwizzled1<T, SOANumeric2<T, GroupType>>;
		using ConstSwizzledType = ConstBaseSwizzled1<T, NumericSOAVec32<T>, SOANumeric2<T, GroupType>>;
	...
	public:
		...
		inline SOANumeric2(const GroupType& a, const GroupType& b)
			: _x(a), _y(b)
		{

		}

		inline SOANumeric2(T a, T b)
			: _x(a), _y(b)
		{
		...
		/*
		inline SOANumeric2& operator= (const SOANumeric1<T, GroupType, Datatype>& other)
		{
			_x = other.x;
			_y = 0.0f;
		...
		*/
		...
		inline SOANumeric2& operator= (const SOANumeric2& other)
		{
			_x = other._x;
			_y = other._y;
		...
		/*
		SOANumeric2& operator= (const SOANumeric3<T, GroupType& other);

		SOANumeric2& operator= (const SOANumeric4<T, GroupType>& other);
		*/

		SOANumeric2& operator= (const SwizzledType& other);

		SOANumeric2& operator= (const ConstSwizzledType& other);
	};

	using Float2 = SOANumeric2<Ceng::FLOAT32, NumericSOAVec32<Ceng::FLOAT32>>;
	...
	template<class T>
	class SOANumericVec2;

	template<class T>
	class SOANumericVec3;

	template<class T>
	class SOANumericVec4;

	template<class T>
	class alignas(16) SOANumericScalar
	{
	public:
		NumericSOAVec32<T> x;
	...
	public:
		...
		inline SOANumericScalar()
		{

		}

		inline SOANumericScalar(const NumericSOAVec32<T>& source)
			: x(source)
		{

		}

		inline SOANumericScalar(T a)
			: x(a)
		{

		}

		inline SOANumericScalar& operator= (const SOANumericScalar& other)
		{
			x = other.x;
			return *this;
		}

		SOANumericScalar& operator= (const SOANumericVec2<T>& other);

		SOANumericScalar& operator= (const SOANumericVec3<T>& other);

		SOANumericScalar& operator= (const SOANumericVec4<T>& other);

		SOANumericScalar& operator= (const SwizzledFloat& other);

		inline SOANumericScalar& operator = (const CR_PixelShaderInput& source)
		{
	...
	template<class T>
	inline SOANumericScalar<T> operator + (const SOANumericScalar<T>& a, const SOANumericScalar<T>& b)
	{
		return a.x + b.x;
	}
	...
	template<class T>
	inline Bool operator == (const SOANumericScalar<T>& a, const SOANumericScalar<T>& b)
	{
		return a.x == b.x;
	}
	...
	using Float = SOANumericScalar<Ceng::FLOAT32>;
	...
	*/
	...
	template<class T>
	class alignas(16) SOANumericVec2
	{
	public:
		NumericSOAVec32<T> _x;
		NumericSOAVec32<T> _y;

	public:
		inline SOANumericVec2()
		{

		}

		inline SOANumericVec2(const NumericSOAVec32<T>& a, const NumericSOAVec32<T>& b)
			: _x(a), _y(b)
		{

		}

		inline SOANumericVec2(T a, T b)
			: _x(a), _y(b)
		{

		}

		inline SOANumericVec2& operator= (const SOANumericScalar<T>& other)
		{
			_x = other.x;
			_y = 0.0f;
		...
		inline SOANumericVec2& operator= (const SOANumericVec2& other)
		{
			_x = other._x;
			_y = other._y;
		...
		SOANumericVec2& operator= (const SOANumericVec3<T>& other);

		SOANumericVec2& operator= (const SOANumericVec4<T>& other);

		SOANumericVec2& operator= (const SwizzledFloat2& other);

		SOANumericVec2& operator= (const ConstSwizzledFloat2& other);

		inline SOANumericVec2& operator = (const CR_PixelShaderInput& source)
		{
	...
	template<class T>
	inline Float2 operator + (const SOANumericVec2<T>& a, const SOANumericVec2<T>& b)
	{
		return { a._x + b._x, a._y + b._y };
	}

	template<class T>
	inline SOANumericVec2<T> operator + (const SOANumericVec2<T>& a, const SOANumericScalar<T>& b)
	{
		return { a._x + b.x, a._y + b.x };
	}

	template<class T>
	inline SOANumericVec2<T> operator - (const SOANumericVec2<T>& a, const SOANumericVec2<T>& b)
	{
		return { a._x - b._x, a._y - b._y };
	}
	...
	template<class T>
	inline Bool operator == (const SOANumericVec2<T>& a, const SOANumericVec2<T>& b)
	{
	...
	//using Float2 = SOANumericVec2<Ceng::FLOAT32>;
	...
	*/
	...
	template<class T>
	class alignas(16) SOANumericVec3
	{
	public:
		NumericSOAVec32<T> _x;
		NumericSOAVec32<T> _y;
		NumericSOAVec32<T> _z;

	public:

		inline SOANumericVec3()
		{

		}

		inline SOANumericVec3(const NumericSOAVec32<T>& x, const NumericSOAVec32<T>& y, const NumericSOAVec32<T>& z)
			: _x(x), _y(y), _z(z)
		{

		}

		inline SOANumericVec3(T x, T y, T z)
			: _x(x), _y(y), _z(z)
		{

		}

		inline SOANumericVec3& operator= (const SOANumericScalar<T>& other)
		{
			_x = other.x;
			_y = 0.0f;
			_z = 0.0f;
		...
		inline SOANumericVec3& operator= (const SOANumericVec2<T>& other)
		{
			_x = other._x;
			_y = other._y;
			_z = 0.0f;
		...
		inline SOANumericVec3& operator= (const SOANumericVec3& other)
		{
			_x = other._x;
			_y = other._y;
			_z = other._z;
		...
		SOANumericVec3& operator= (const SOANumericVec4<T>& other);

		inline SOANumericVec3& operator = (const CR_PixelShaderInput& source)
		{
		...
		SOANumericVec3& operator= (const SwizzledFloat3& other);

		SOANumericVec3& operator= (const ConstSwizzledFloat3& other);
	...
	template<class T>
	inline SOANumericVec3<T> operator + (const SOANumericVec3<T>& a, const SOANumericVec3<T>& b)
	{
		return { a._x + b._x, a._y + b._y, a._z + b._z };
	}

	template<class T>
	inline SOANumericVec3<T> operator + (const SOANumericVec3<T>& a, const Float& b)
	{
	...
	template<class T>
	inline Bool operator == (const SOANumericVec3<T>& a, const SOANumericVec3<T>& b)
	{
	...
	*/
	...
	template<class T>
	class alignas(16) SOANumericVec4
	{
	public:
		NumericSOAVec32<T> _x;
		NumericSOAVec32<T> _y;
		NumericSOAVec32<T> _z;
		NumericSOAVec32<T> _w;

	public:
		inline SOANumericVec4()
		{

		}

		inline SOANumericVec4(const NumericSOAVec32<T>& x, const NumericSOAVec32<T>& y, const NumericSOAVec32<T>& z, const NumericSOAVec32<T>& w)
			: _x(x), _y(y), _z(z), _w(w)
		{

		}

		inline SOANumericVec4(T x, T y, T z, T w)
			: _x(x), _y(y), _z(z), _w(w)
		{

		}

		inline SOANumericVec4& operator= (const SOANumericScalar<T>& other)
		{
			_x = other.x;
			_y = 0.0f;
			_z = 0.0f;
		...
		inline SOANumericVec4& operator= (const SOANumericVec2<T>& other)
		{
			_x = other._x;
			_y = other._y;
			_z = 0.0f;
		...
		inline SOANumericVec4& operator= (const SOANumericVec3<T>& other)
		{
			_x = other._x;
			_y = other._y;
			_z = other._z;
		...
		inline SOANumericVec4& operator= (const SOANumericVec4& other)
		{
			_x = other._x;
			_y = other._y;
			_z = other._z;
		...
		inline SOANumericVec4& operator = (const CR_PixelShaderInput& source)
		{
		...
		SOANumericVec4& operator = (const SampleTexture2D& source);

		SOANumericVec4& operator = (const SwizzledFloat4& source);

		SOANumericVec4& operator = (const ConstSwizzledFloat4& source);
	...
	template<class T>
	inline SOANumericVec4<T> operator + (const SOANumericVec4<T>& a, const SOANumericVec4<T>& b)
	{
		return { a._x + b._x, a._y + b._y, a._z + b._z, a._w + b._w };
	}

	template<class T>
	inline SOANumericVec4<T> operator + (const SOANumericVec4<T>& a, const Float& b)
	{
	...
	template<class T>
	inline Bool operator == (const SOANumericVec4<T>& a, const SOANumericVec4<T>& b)
	{
	...
	*/
	...
	using Float4 = SOANumericVec4<Ceng::FLOAT32>;
	...
	*/
	...
	/*
	template<class T>
	inline SOANumericScalar<T>& SOANumericScalar<T>::operator= (const SOANumericVec2<T>& other)
	{
		x = other._x;
		return *this;
	}
	...
	template<class T>
	inline SOANumericScalar<T>& SOANumericScalar<T>::operator= (const SOANumericVec3<T>& other)
	{
		x = other._x;
		return *this;
	}
	...
	template<class T>
	inline SOANumericScalar<T>& SOANumericScalar<T>::operator= (const SOANumericVec4<T>& other)
	{
		x = other._x;
		return *this;
	}
	...
	template<class T>
	inline SOANumericScalar<T>& SOANumericScalar<T>::operator= (const SwizzledFloat& other)
	{
		x = *other.base;
		return *this;
	}
	...
	*/
	...
	/*
	template<class T>
	inline SOANumericVec2<T>& SOANumericVec2<T>::operator= (const SOANumericVec3<T>& other)
	{
		_x = other._x;
		_y = other._y;
	...
	template<class T>
	inline SOANumericVec2<T>& SOANumericVec2<T>::operator= (const SOANumericVec4<T>& other)
	{
		_x = other._x;
		_y = other._y;
	...
	*/
	...
	template<class T, class GroupType, class Datatype, class SwizzledType, class ConstSwizzledType>
	inline SOABase2<T, GroupType, Datatype, SwizzledType, ConstSwizzledType>& 
		SOABase2<T, GroupType, Datatype, SwizzledType, ConstSwizzledType>::operator= (const SwizzledType& other)
	{
		if (other.base == &_x)
		{
			GroupType temp[2];
	...
	template<class T, class GroupType, class Datatype, class SwizzledType, class ConstSwizzledType>
	inline SOABase2<T, GroupType, Datatype, SwizzledType, ConstSwizzledType>& 
		SOABase2<T, GroupType, Datatype, SwizzledType, ConstSwizzledType>::operator= (const ConstSwizzledType& other)
	{
		if (other.base == &_x)
		{
			GroupType temp[2];
	...
	template<class T, class GroupType, class Datatype, class SwizzledType, class ConstSwizzledType>
	inline SwizzledType SOABase2<T, GroupType, Datatype, SwizzledType, ConstSwizzledType>::x()
	{
		return SwizzledType(&_x, 0);
	}

	template<class T, class GroupType, class Datatype, class SwizzledType, class ConstSwizzledType>
	inline SwizzledType SOABase2<T, GroupType, Datatype, SwizzledType, ConstSwizzledType>::y()
	{
		return SwizzledType(&_y, 1);
	}

	template<class T, class GroupType, class Datatype, class SwizzledType, class ConstSwizzledType>
	inline ConstSwizzledType SOABase2<T, GroupType, Datatype, SwizzledType, ConstSwizzledType>::xx()
	{
		return ConstSwizzledType(&_x, 0, 0);
	}

	template<class T, class GroupType, class Datatype, class SwizzledType, class ConstSwizzledType>
	inline SwizzledType SOABase2<T, GroupType, Datatype, SwizzledType, ConstSwizzledType>::xy()
	{
		return SwizzledType(&_x, 0, 1);
	}

	template<class T, class GroupType, class Datatype, class SwizzledType, class ConstSwizzledType>
	inline SwizzledType SOABase2<T, GroupType, Datatype, SwizzledType, ConstSwizzledType>::yx()
	{
		return SwizzledType(&_x, 1, 0);
	}

	template<class T, class GroupType, class Datatype, class SwizzledType, class ConstSwizzledType>
	inline ConstSwizzledType SOABase2<T, GroupType, Datatype, SwizzledType, ConstSwizzledType>::yy()
	{
		return ConstSwizzledType(&_x, 1, 1);
	}
	...
	*/
	...
	template<class T>
	inline SOANumericVec3<T>& SOANumericVec3<T>::operator= (const SOANumericVec4<T>& other)
	{
		_x = other._x;
		_y = other._y;
		_z = other._z;
	...
	template<class T>
	inline SOANumericVec3<T>& SOANumericVec3<T>::operator= (const SwizzledFloat3& other)
	{
		if (other.base == &_x)
		{
			SOAVecFloat temp[3];
	...
	template<class T>
	inline SOANumericVec3<T>& SOANumericVec3<T>::operator= (const ConstSwizzledFloat3& other)
	{
		if (other.base == &_x)
		{
			SOAVecFloat temp[3];
	...
	template<class T>
	inline SwizzledFloat SOANumericVec3<T>::x()
	{
		return SwizzledFloat(&_x, 0);
	}

	template<class T>
	inline SwizzledFloat SOANumericVec3<T>::y()
	{
		return SwizzledFloat(&_y, 1);
	}

	template<class T>
	inline SwizzledFloat SOANumericVec3<T>::z()
	{
		return SwizzledFloat(&_z, 2);
	}

	template<class T>
	inline ConstSwizzledFloat2 SOANumericVec3<T>::xx()
	{
		return ConstSwizzledFloat2(&_x, 0, 0);
	}

	template<class T>
	inline SwizzledFloat2 SOANumericVec3<T>::xy()
	{
		return SwizzledFloat2(&_x, 0, 1);
	}

	template<class T>
	inline SwizzledFloat2 SOANumericVec3<T>::xz()
	{
		return SwizzledFloat2(&_x, 0, 2);
	}

	template<class T>
	inline SwizzledFloat2 SOANumericVec3<T>::yx()
	{
		return SwizzledFloat2(&_x, 1, 0);
	}

	template<class T>
	inline ConstSwizzledFloat2 SOANumericVec3<T>::yy()
	{
		return ConstSwizzledFloat2(&_x, 1, 1);
	}

	template<class T>
	inline SwizzledFloat2 SOANumericVec3<T>::yz()
	{
		return SwizzledFloat2(&_x, 1, 2);
	}

	template<class T>
	inline SwizzledFloat2 SOANumericVec3<T>::zx()
	{
		return SwizzledFloat2(&_x, 2, 0);
	}

	template<class T>
	inline SwizzledFloat2 SOANumericVec3<T>::zy()
	{
		return SwizzledFloat2(&_x, 2, 1);
	}

	template<class T>
	inline ConstSwizzledFloat2 SOANumericVec3<T>::zz()
	{
		return ConstSwizzledFloat2(&_x, 2, 2);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::xxx()
	{
		return ConstSwizzledFloat3(&_x, 0, 0, 0);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::xxy()
	{
		return ConstSwizzledFloat3(&_x, 0, 0, 1);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::xxz()
	{
		return ConstSwizzledFloat3(&_x, 0, 0, 2);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::xyx()
	{
		return ConstSwizzledFloat3(&_x, 0, 1, 0);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::xyy()
	{
		return ConstSwizzledFloat3(&_x, 0, 1, 1);
	}

	template<class T>
	inline SwizzledFloat3 SOANumericVec3<T>::xyz()
	{
		return SwizzledFloat3(&_x, 0, 1, 2);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::xzx()
	{
		return ConstSwizzledFloat3(&_x, 0, 2, 0);
	}

	template<class T>
	inline SwizzledFloat3 SOANumericVec3<T>::xzy()
	{
		return SwizzledFloat3(&_x, 0, 2, 1);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::xzz()
	{
		return ConstSwizzledFloat3(&_x, 0, 2, 2);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::yxx()
	{
		return ConstSwizzledFloat3(&_x, 1, 0, 0);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::yxy()
	{
		return ConstSwizzledFloat3(&_x, 1, 0, 1);
	}

	template<class T>
	inline SwizzledFloat3 SOANumericVec3<T>::yxz()
	{
		return SwizzledFloat3(&_x, 1, 0, 2);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::yyx()
	{
		return ConstSwizzledFloat3(&_x, 1, 1, 0);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::yyy()
	{
		return ConstSwizzledFloat3(&_x, 1, 1, 1);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::yyz()
	{
		return ConstSwizzledFloat3(&_x, 1, 1, 2);
	}

	template<class T>
	inline SwizzledFloat3 SOANumericVec3<T>::yzx()
	{
		return SwizzledFloat3(&_x, 1, 2, 0);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::yzy()
	{
		return ConstSwizzledFloat3(&_x, 1, 2, 1);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::yzz()
	{
		return ConstSwizzledFloat3(&_x, 1, 2, 2);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::zxx()
	{
		return ConstSwizzledFloat3(&_x, 2, 0, 0);
	}

	template<class T>
	inline SwizzledFloat3 SOANumericVec3<T>::zxy()
	{
		return SwizzledFloat3(&_x, 2, 0, 1);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::zxz()
	{
		return ConstSwizzledFloat3(&_x, 2, 0, 2);
	}

	template<class T>
	inline SwizzledFloat3 SOANumericVec3<T>::zyx()
	{
		return SwizzledFloat3(&_x, 2, 1, 0);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::zyy()
	{
		return ConstSwizzledFloat3(&_x, 2, 1, 1);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::zyz()
	{
		return ConstSwizzledFloat3(&_x, 2, 1, 2);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::zzx()
	{
		return ConstSwizzledFloat3(&_x, 2, 2, 0);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::zzy()
	{
		return ConstSwizzledFloat3(&_x, 2, 2, 1);
	}

	template<class T>
	inline ConstSwizzledFloat3 SOANumericVec3<T>::zzz()
	{
		return ConstSwizzledFloat3(&_x, 2, 2, 2);
	}
