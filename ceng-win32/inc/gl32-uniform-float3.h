...
#ifndef GL32_UNIFORM_FLOAT3_H
#define GL32_UNIFORM_FLOAT3_H

#include "gl32-shader-const.h"

namespace Ceng
{
	class GL32_UniformFloat3 : public GL32_ShaderConstant
	{
	public:
	...
	public:
		GL32_UniformFloat3();
		GL32_UniformFloat3(GLint index, Ceng::GL32_ShaderProgram *program);

		virtual ~GL32_UniformFloat3();
