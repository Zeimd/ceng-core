...
#ifndef GL32_UNIFORM_FLOAT4_H
#define GL32_UNIFORM_FLOAT4_H

#include "gl32-shader-const.h"

namespace Ceng
{
	class GL32_UniformFloat4 : public GL32_ShaderConstant
	{
	public:
	...
	public:
		GL32_UniformFloat4();
		GL32_UniformFloat4(GLint index, Ceng::GL32_ShaderProgram *program);

		virtual ~GL32_UniformFloat4();
