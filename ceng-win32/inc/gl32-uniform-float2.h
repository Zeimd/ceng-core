...
#ifndef GL32_UNIFORM_FLOAT2_H
#define GL32_UNIFORM_FLOAT2_H

#include "gl32-shader-const.h"

namespace Ceng
{
	class GL32_UniformFloat2 : public GL32_ShaderConstant
	{
	public:
	...
	public:
		GL32_UniformFloat2();
		GL32_UniformFloat2(GLint index, Ceng::GL32_ShaderProgram *program);

		virtual ~GL32_UniformFloat2();
